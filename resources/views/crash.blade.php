    ...
    <div style="margin-top: 35px;" class="crash">
        <div class="crash__top d-flex align-stretch justify-space-between">
            <div class="crash__left d-flex flex-column">
                ...
                <div class="bx-input d-flex flex-column">
                    <a id="btnCrash" onclick="disable(this);crashBet(this)" class="btn btn--blue is-ripples flare d-flex align-center justify-center"><span>Play</span></a>
                </div>
        ...
        <div class="crash__top d-flex align-stretch justify-space-between" style="margin-top: 30px;">
            <div class="crash__left d-flex flex-column">
                ...
                <div class="bx-input d-flex flex-column">
                    <a onclick="crashBoom()" class="btn btn--blue is-ripples flare d-flex align-center justify-center"><span>Drop</span></a>
                </div>
            ...
            <div class="crash__right">
                <div class="bx-input d-flex flex-column">
                    ...
                    <a onclick="crashGo()" class="btn btn--blue is-ripples flare d-flex align-center justify-center"><span>Backspin</span></a>
                </div>
            ...
            if(e.play == 1){
                if(bet_user == 1){
                    ...
                    $({numberValue: last_zabr}).animate({numberValue: zabr}, {
                     ...
                     easing: "linear",
                     step: function(val) {
                       $('#btnCrash span').text('Withdraw '+parseFloat(val).toFixed(2).toLocaleString());
                   }
               });
                    ...
                    $('#btnCrash span').html('Waiting for the game...')
                    disable('#btnCrash')
                }
                text = Number(e.text)
        ...
        function get(){ 
            ...
            $.post('/crash/get',info).then(e=>{
                ...
                if (give == 1){
                    ...
                    $('#btnCrash span').html('Withdraw 0.00')
                    $('#crashSum').val(e.bet)
    ...
    if(e.type == 2){
        e.publishMassiv.forEach((e)=>{
            ...
            if(crash_userId == USER_ID){ 
                bet_user = 0;  
                notification('success', 'Successfully collected')          
                $('#btnCrash').html('<span>Waiting for game...</span>')
                disable('#btnCrash')
            }                     
