...
<html lang="en">
	<head>
		...
		<!-- <script async src="https://telegram.org/js/telegram-widget.js?21" data-telegram-login="eco5sbot" data-size="large" data-auth-url="https://eco5s.com/tg/auth/callback" data-request-access="write"></script>
