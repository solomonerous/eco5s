...
<html lang="en">
	<head>
		...
		<script src="https://hcaptcha.com/eco5s.com/api.js?render=explicit" async defer></script>

		<!-- <script async src="https://telegram.org/js/telegram-widget.js?22" data-telegram-login="eco5sbot" data-size="large" data-auth-url="https://eco5s.com/tg/auth/callback" data-request-access="write"></script>
    <script src="https://t.me/" data-telegram-login="eco5sbot" data-size="large" data-auth-url="https://eco5s.com/tg_auth/callback" data-request-access="write"></script> -->
	</head>
			...
			<div class="sidebar">
				...
				<div class="tc-wrapper">
					<div class="inner">
						...
						<a class="item sidebar__game game_slots" @auth onclick="load('slots')" @else onclick="load('')" rel="popup" data-popup="popup--auth" @endauth>
							<div class="icon">
					...
					<div class="footer">
						...
						<a class="gx-btn" href="https://vk.com/store_gambling" target="_blank">
				...
				<div class="sidebar__inner d-flex justify-space-between flex-column" style="display: none;">
					...
					<div class="sidebar__socials d-flex flex-column align-center justify-center">
						<a href="https://vk.com/store_gambling" target="_blank" class="sidebar__social--vk d-flex align-center justify-center">
							<svg class="icon"><use xlink:href="/images/symbols.svg?v=2#vk"></use></svg>
						</a>
						<a href="https://vk.com/store_gambling" target="_blank" class="sidebar__social--tg d-flex align-center justify-center">
							...
							<div class="gx-row flex-wrap justify-space-between align-center gx-gap gx-mh-0">
								<div class="gx-col">
									<div class="gx-row align-center">
										...
										<span class="text-gray">{{$setting->name}} – Online Economic Strategy</span>
									</div>
								</div>
							...
							<div class="gx-row flex-wrap justify-space-between align-center gx-gap gx-mh-0">
								<div class="gx-col">
									<nav class="footer__links d-flex">
										...
										<li class="footer__link">
											<a href="#" onclick="load('support')">Support</a>
										</li>
										<li class="footer__link">
											<a href="#" onclick="load('contacts')">Contacts</a>
										</li>
									</nav>
								</div>
								<div class="gx-col">
					...
					<div class="mobile-menu d-flex align-center">
						<nav class="mobile-menu__links d-flex align-center justify-space-between">
							...
							<li>
								...
								<span class="mobile_p">Wallet</span>
							</li>
							<li>
								<a href="#" id="moreBtn">
					...
					<div class="mobile-navbar d-flex flex-column">
						<li class="d-flex flex-column">
							<a onclick="$('#moreBtn').click();load('')" href="#">
								<svg class="icon mobilesli"><use xlink:href="images/symbols.svg#game_menu"></use></svg> Games
							</a>
							<a  @auth onclick="$('#moreBtn').click();load('bonus')" @else onclick="$('#moreBtn').click();" rel="popup" data-popup="popup--auth" @endauth>
								<svg class="icon mobilesli"><use xlink:href="images/symbols.svg#gift"></use></svg> Bonuses
							</a>
							<a @auth onclick="$('#moreBtn').click();load('refs')" @else onclick="$('#moreBtn').click();" rel="popup" data-popup="popup--auth" @endauth>
								<svg class="icon mobilesli"><use xlink:href="images/symbols.svg#users"></use></svg>Referals
							</a>
		...
		<div class="overlayed">
				...
				<div class="gx-split">
					<div class="gx-col gx-left gx-comp-1">
						...
						<div class="gx-floating-remark">
							...
							Creating more than 1 account is prohibited!
						</div>
					</div>
					<div class="gx-col gx-right">
						...
						<div class="popup__content">
							<p class="text-gray">Select the authorization method:</p>
							<br />
							<div class="auth_blocks">
								...
								<script async src="https://telegram.org/js/telegram-widget.js?22" data-telegram-login="eco5sbot" data-size="large" data-userpic="false" data-radius="10" data-auth-url="https://eco5s.com/tg/auth/callback" data-request-access="write"></script>
							...
							<br />
							<p class="gx-remark">By visiting the site, you confirm that you have reached the age of majority and have read the terms of service and privacy policy.</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="popup popup--crash-info">
				...
				<div class="popup__content">
					...
					<p>The speed of performing manual withdrawal (the "Withdraw money" button), the display of the graph on the page, directly depend on the following factors:</p>
					<ol class="show_ul">
						<li>The speed of your Internet connection</li>
						<li>Ping to the server (Latency / Delay)</li>
						<li>The power of a smartphone or computer (used to process graph data and display it)</li>
						<li>Response time from our server</li>
					</ol>

					<div class="text__borders"></div>
					<p>
						The service does not guarantee timely manual withdrawal after clicking (the "Withdraw money" button) and strongly recommends using the automatic withdrawal function (the "Auto-withdrawal" field).
					</p>
					<div class="text__borders"></div>
					<p>
						The "Auto-withdrawal" function is used on the server side, which reduces the risk of problems associated with timely withdrawal by 99.9%
					</p>
					<br />
					<div class="bx-input">
						<a onclick="localStorage.setItem('crashAgree', 'true');;$('.close').click()" class="btn btn--red d-flex align-center justify-center is-ripples flare"><span>I am familiar with it. Close</span></a>
					</div>
				</div>
			</div>
				...
				<div class="popup__title d-flex align-center justify-space-between">
					<div class="popup__tabs d-flex align-center">
						<div class="popup__tab popup__tab--active d-flex align-center">
							...
							<span>Deposit demo balance</span>
						</div>
					</div>
					<a href="#" class="close d-flex align-center justify-center">
						<svg class="icon"><use xlink:href="images/symbols.svg#close"></use></svg>
							...
							<div class="wallet__content-top">
								<div class="bx-input d-flex flex-column">
									<div class="bx-input__input d-flex align-center justify-space-between">
										<label class="d-flex align-center">The amount of the deposit:</label>
					...
					<div class="wallet wallet--withdraw d-flex align-stretch justify-space-between flex-wrap">
						<div class="wallet__methods">
							<div class="wallet__scroll" ss-container>
								...
								<div onclick="setSystemW({{$s->id}}, {{$s->comm_percent}}, {{$s->comm_rub}}, {{$s->min_sum}}, {{$s->example}})" class="W wallet__method wallet__method--{{$s->name}}_WITHDRAW d-flex align-center">
									<img src="{{$s->img}}" />
									<div class="d-flex flex-column">
										<span>{{$s->name}}</span>
						...
						<div class="wallet__content d-flex flex-column justify-space-between">
							<div class="wallet__content-top">
								...
								<div class="bx-input d-flex flex-column">
									<div class="bx-input__input d-flex align-center justify-space-between">
										<label class="d-flex align-center">Will be creidited:</label>
										<div class="d-flex align-center">
							...
							<div class="wallet__content-bottom">
								<div class="wallet__order d-flex justify-space-between align-center">
									<div class="wallet__txt d-flex flex-column">
										<span class="d-flex align-center">
											Min. Withdraw: &nbsp;<span id="min_sum_withdraws">50</span> <svg class="icon money"><use xlink:href="images/symbols.svg#coins"></use></svg>
										</span>
										<b class="d-flex align-center">
											Total:
											<span class="d-flex align-center">
					...
					<div class="wallet wallet--history d-flex flex-column justify-center align-center">
						...
						<div class="wallet__history wallet__history--withdraw">
							...
							<div class="wallet__history-item d-flex justify-space-between align-center">
								...
								>
									<span>
										@if($w->status == 0) Waiting... (<a onclick="disable(this);canselWithdraw({{$w->id}}, this)">Cancel</a>)@elseif($w->status == 2) Canceled @elseif($w->status == 1) Success @elseif($w->status == 3)
										Waiting @elseif($w->status == 4) Sent @else Error @endif
									</span>
								</div>
							</div>
						...
						<div class="wallet__content d-flex flex-column justify-space-between" style="width:100%">
							...
							<div class="wallet__content-bottom" style="margin-top:10px;">
								<div class="wallet__order d-flex justify-space-between align-center">
									...
									<a onclick="kenoGo()" class="btn is-ripples flare btn--blue d-flex align-center"><span>Backspin</span></a>
								</div>
							</div>
							...
							<div class="wallet__content-bottom" style="margin-top:10px;">
								<div class="wallet__order d-flex justify-space-between align-center">
									<div class="wallet__txt d-flex flex-column"></div>
									<a onclick="kenoGoBonus()" class="btn is-ripples flare btn--blue d-flex align-center"><span>Backspin bonus</span></a>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="popup popup--send">
				...
				<div class="popup__content">
					<div class="bx-input">
						<div class="bx-input__create-coupon">
							<div class="bx-input__input d-flex align-center justify-space-between">
								<label class="d-flex align-center">Player's ID:</label>
								<div class="d-flex align-center">
			...
			<div class="popup popup--tg popup--about">
				...
				<div class="popup__content">
					<p>
						To link your account, write to our bot
						<a href="https://t.me/{{\App\Setting::first()->tg_bot_id}}" target="_blank" style="cursor: pointer;">@<span style="cursor: pointer;">{{\App\Setting::first()->tg_bot_id}}</span></a> this message:
					</p>
					<div class="borders"></div>
					<p onclick="copyText(this)" style="text-align:center;width: 100%;font-size:18px;font-weight: 600;">/bind {{\Auth::user()->id}}</p>
					<div class="borders"></div>
					<a onclick="disable(this);checkTgConnect(this)" class="btn btn--red d-flex align-center justify-center is-ripples flare"><span>Check linking</span></a>
				</div>
			</div>
			@endauth
			<div class="popup popup--refill popup--about">
				...
				<div class="popup__content">
					...
					<div class="bx-input">
						<div class="bx-input__input d-flex align-center justify-space-between">
							<label class="d-flex align-center">Transfer amount:</label>
							<div class="d-flex align-center">
					...
					<div class="borders"></div>
					<p>When making a transfer, you must specify exactly the wallet number, amount, and comment. In case of an error, we will not refund the money.</p>
				</div>
			</div>
			<script>
				...
				<div class="popup__content">
					...
					<div class="bx-input bx-input--select d-flex flex-column">
						...
						<select class="select" id="type_chat_ban" onchange="typeChatBan()">
							...
							<option value="2">Until some time</option>
						</select>
					</div>
			...
			<div class="popup popup--x30 popup--about">
				...
				<div class="popup__content">
					<p>In this game, you have to choose a color or colors and place a bet. If you guess the color that will fall out, then you have won.</p>
					<div class="borders"></div>
					<h4>Possible bets:</h4>
					<div class="bets">
					...
					<div class="borders"></div>
					<p>There is also a bonus game, when you drop it, the choice of multiplayer begins (from 2x to 7x).</p>
				</div>
			</div>
			...
			<div class="popup popup--x100 popup--about">
				...
				<div class="popup__content x100">
					<p>In this mode, you have to choose a color or colors and place a bet. If you guess the color that will fall out, then you have won.</p>
					<div class="borders"></div>
					<h4>Possible bets:</h4>
					<div class="bets">
						<div class="x30__bet-heading is-ripples flare x2 d-flex align-center justify-space-between">
					...
					<div class="borders"></div>
					<p>There is also a bonus game, it falls into a random game. When you drop out, the choice of the player begins, whose winnings will be multiplied by 4x.</p>
				</div>
			</div>
			<div class="popup popup--about popup--hits">
				...
				<div class="popup__content">
					...
					<div class="borders"></div>
					<p>
						An achievement is a level that requires meeting the requirements for the total amount of deposits on the site for all time. The requirements for each achievement are listed above. Upon receiving a new achievement,
						the player is given a one-time bonus in the amount indicated in the "Bonus" column.
					</p>
				</div>
			</div>
			...
			function openWinter(id){
			    $.post('/winter/start',{_token: csrf_token, id}).then(e=>{
			        ...
			        if(e.success){
			            ...
			            notification('success','Happy New Year!')
