		...
		<div class="dice__bet">
			<div class="dice__procent">
				<div class="bx-input__input d-flex align-center justify-space-between">
					<label class="d-flex align-center">Percent:</label>
			...
			<div class="dice__x">
				<div class="bx-input__input d-flex align-center justify-space-between">
					<label class="d-flex align-center">Ratio:</label>
			...
			<div class="dice__play d-flex justify-center align-center" style="grid-column: 1 / 4;">
				...
				<a  class="btn is-ripples flare btn--red d-flex align-center" onclick="newGame(this)" id="dice__replay" style="display: none;" ><span>Play again</span></a>
			</div>

		</div>
		<div style="text-align:center;width: 100%;margin-top: 15px;font-weight: bold;cursor: pointer;display: none;"  id="checkDice" class=""><a  onclick="return false;" rel="popup" data-popup="popup--fair-dice">Check game</a></div>
	</div>
</div>
<div class="wrapper">
