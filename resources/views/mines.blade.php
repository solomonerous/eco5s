<div class="mines d-flex justify-center" style="margin-top:35px">
	<div class="mines__wrapper d-flex justify-space-between align-start flex-wrap">
		<div class="mines__left d-flex flex-column justify-center align-center">
			...
			<div class="bx-input">
				<div class="bx-input__input d-flex justify-space-between align-center">
					<label class="d-flex align-center">Amount of bombs:</label>
			...
			<div class="bx-input start_block_mine" style="display: none;">
				<a  onclick="disable(this);startGameMineNew(this)" class="btn btn--blue d-flex align-center justify-center is-ripples flare"><span>Start</span></a>
				
			</div>
			<div class="bx-input mines__buttons play_block_mine" style="display:none">
				<a  onclick="disable(this);disable('.mines__path-item');finishGameMineNew(this)" class="btn btn--blue d-flex align-center justify-center is-ripples flare"><span>Withdraw <span id="winMine">0.00</span></span></a>
				<a  onclick="disable(this);autoClickMineNew(this)" class="btn d-flex align-center justify-center is-ripples flare"><span>Auto-choice</span></a>
			</div>
			<div class="bx-input">
				<div class="mines__x">
