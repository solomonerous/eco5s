    ...
    <div style="margin-top: 35px;" class="shoot">
        <div class="shoot__live" id="tir">
            ...
            <div class="shoot__live-drop">
                ...
                <div class="shoot__live-drop-game d-flex align-center justify-center">
                    <a class="btn btn--orange is-ripples flare d-flex align-center has-ripple" id="game" onclick="disable(this);startGameShoot(this);"><span>Try your luck</span></a>
                    <a class="btn btn--orange is-ripples flare d-flex align-center has-ripple" onclick="disable(this);shootGame(this);" style="display: none;" id="shoot"><span>Shoot</span></a>
                </div>
            </div>
        </div>
        <!-- CASH HUNT WINDOW -->
        <div class="shoot__live shoot__live--game d-flex flex-column align-center justify-center" id="cashhunt" style="display: none;">
            <div class="shoot__game-wrapper CashHunt">
                ...
                <div class="shoot__live-drop-game d-flex align-center justify-center">
                    <a onclick="disable(this);startCashHuntGame(this)" class="btn btn--orange is-ripples flare d-flex align-center has-ripple"><span>Play</span></a>
                </div>
            </div>
        </div>
        <!-- ###### -->
