		...
		<div class="bonus__top">
			<div class="bonus__items">
				<div class="bonus__item">
					...
					<div class="bonus__content d-flex justify-space-between align-center">
						<div class="bx-input__input d-flex align-center justify-space-between">
							<label class="d-flex align-center">Size:</label>
						...
						<div class="bonus__buttons d-flex align-center">
							<a href="#" onclick="disable(this);getBonusVk(this)" class="btn btn--blue is-ripples flare d-flex align-center"><span>Get</span></a>
				...
				<div class="bonus__item bonus__item--block bonus__item--levels" style="display: none;">
					<div class="bonus__item-title"><span>Levels</span></div>
					<div class="bonus__content d-flex align-center justify-space-between flex-wrap">
						<div class="bonus__levels-info d-flex align-center flex-wrap">
							...
							<div class="bonus__levels-text d-flex flex-column">
								<span>Increase your rank and get prizes!</span>
								<p>Experience is credited for deposits.</p>
							</div>
						</div>
						<div class="bonus__levels-items" id="all_bonusStatus_table">
							<div class="bonus__levels-item bonus__levels-item--1 d-flex flex-column align-center justify-center">
								<h4>Level 1</h4>
								<span class="user-status new" style="margin-bottom: 15px;">Beginner</span>
								<a href="#" class="btn is-ripples flare btn--orange d-flex align-center"><span>From 1 to 3</span></a>
							</div>
						</div>
					</div>
				</div>
				<div class="bonus__item bonus__item--block bonus__item--reposts">
					<div class="bonus__item-title"><span>Bonus for reposts</span></div>
					<div class="bonus__content d-flex justify-space-between align-center">
						<div class="bx-input__input d-flex align-center justify-space-between"  style="width: 84%;">
							<label class="d-flex align-center">Bonus balance:</label>
							<div class="d-flex align-center">
						...
						<div class="bonus__buttons d-flex align-center">
							<a href="#" onclick="disable(this);changeRepostBalance(this)" class="btn btn--blue is-ripples flare d-flex align-center"><span>Exchange</span></a>
						</div>
					</div>
				...
				$.post('/repost/all',{_token: csrf_token}).then(e=>{
					...
					e.repost.forEach((e)=>{
						...
						if(percent > 100) { percent = 100 }
							...
							<span class="bonus__reposts-level">'+e.id+' level</span>\
			...
			function getStatus() {
				$.post('/status/all',{_token: csrf_token}).then(e=>{
					...
					e.status.forEach((e)=>{
						...
						if(USER_STATUS == e.id){
							textBonus = 'From '+e.minSumBonus+' to '+e.maxSumBonus
						}else{
